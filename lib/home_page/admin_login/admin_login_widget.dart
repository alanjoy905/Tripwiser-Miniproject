    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: Container(
          ...
          alignment:
              AlignmentDirectional(-0.09999999999999998, -0.09999999999999998),
          child: Stack(
            children: [
              Align(
                                        ...
                                        child: TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                            ...
                                            hintText:
                                                FFLocalizations.of(context)
                                                    .getText(
                                              'r2t2gx7b' /* Enter your email here... */,
                                            ),
                                            hintStyle:
                                                FlutterFlowTheme.of(context)
                                                    .bodySmall,
                                        ...
                                        child: TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                            ...
                                            hintText:
                                                FFLocalizations.of(context)
                                                    .getText(
                                              'iafwuf87' /* Enter your password here... */,
                                            ),
                                            hintStyle:
                                                FlutterFlowTheme.of(context)
                                                    .bodySmall,
                                        ...
                                        onPressed: () async {
                                          ...
                                          if (valueOrDefault<bool>(
                                            ...
                                            ScaffoldMessenger.of(context)
                                              ...
                                              SnackBar(
                                                content: Text(
                                                  'Login Denied ! You Are Not An Admin',
                                                  style: TextStyle(
